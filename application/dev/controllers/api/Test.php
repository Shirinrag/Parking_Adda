...
/*reserve_from_time)); //21 4
  ...
  public function exports_data(){
            ...
            $data=$this->db->select('*')->from('mpc_sensor')->where('device_id','5')->where('created_date>=','2022-04-08 18:00:00')
            ->order_by('id DESC')->get()->result_array();
            // $totaldata=array_push($newdata,$data);
             header("Content-type: application/csv");
            header("Content-Disposition: attachment; filename=\"device_new5".".csv\"");
    ...
    public function booking_extention()
    {
            ...
            ->run())
        {
            ...
            $uniqueBookingId = $this
                ...
                ->where('booking_status','0')->get()->result_array();
