...
class Auth_model extends CI_Model{
	...
	public function login($data){
		...
		$this->db->join('ci_admin_roles','ci_admin_roles.admin_role_id = ci_admin.admin_role_id','left');
		$this->db->join('ci_call_extentions','ci_admin.admin_id = ci_call_extentions.cc_id','left');
