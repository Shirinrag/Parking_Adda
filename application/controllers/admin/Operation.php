...
class Operation extends MY_Controller {
    ...
    public function operations_datatable_json() {
        ...
        foreach ($records['data'] as $row) {
            ...
            $address = "<b>Address : </b>" . $row['place_address'] . "<br>" . "<b>City : </b>" . $row['city_name'] . "," . "&nbsp" . "<b>Pincode :</b>" . $row['pincode'] . "." . "<br>" . "<b>State : </b>" . $row['state_name'] . "<br>" . "<b>Country : </b>" . $row['country_name'] . "<br>";
            $data[] = array(++$i, $row['placename'], $address, $row['vendor_name'], $row['no_of_slots'], $view,);
        }
        $records['data'] = $data;
