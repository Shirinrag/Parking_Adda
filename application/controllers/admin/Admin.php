    ...
    function add() {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $var = $this->input->post('mobile_no') . "MPC" . "Verifier";
                $notify = ($this->input->post('role') == 3) ? $var : '';
                $data = array('admin_role_id' => $this->input->post('role'), 'username' => $this->input->post('username'), 'firstname' => $this->input->post('firstname'), 'lastname' => $this->input->post('lastname'), 'email' => $this->input->post('email'), 'mobile_no' => $this->input->post('mobile_no'), 'notifn_topic' => $notify, 'password' => password_hash($this->input->post('password'), PASSWORD_BCRYPT), 'is_active' => 1, 'created_at' => date('Y-m-d : h:m:s'), 'updated_at' => date('Y-m-d : h:m:s'),);
    ...
    function edit($id = "") {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data = array('admin_role_id' => $this->input->post('role'), 'username' => $this->input->post('username'), 'firstname' => $this->input->post('firstname'), 'lastname' => $this->input->post('lastname'), 'email' => $this->input->post('email'), 'mobile_no' => $this->input->post('mobile_no'), 'is_active' => 1, 'updated_at' => date('Y-m-d : h:m:s'),);
