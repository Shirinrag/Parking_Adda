...
class Wallet extends MY_Controller {
    ...
    public function datatable_json() {
        ...
        foreach ($records['data'] as $row) {
            ...
            $data[] = array(++$i, $modified_date, $row['username'], $row['amount'], '<input class="tgl_checkbox tgl-ios" 
				...
				' . $status . '><label for="cb_' . $row['id'] . '"></label>', '<a title="View" class="view btn btn-sm btn-info" href="' . base_url('admin/wallet/edit/' . $row['id']) . '"> <i class="fa fa-eye"></i></a>
