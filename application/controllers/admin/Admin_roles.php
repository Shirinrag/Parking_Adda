    ...
    public function module_add() {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data = array('module_name' => $this->input->post('module_name'), 'controller_name' => $this->input->post('controller_name'), 'fa_icon' => $this->input->post('fa_icon'), 'operation' => $this->input->post('operation'), 'sort_order' => $this->input->post('sort_order'),);
    ...
    public function sub_module_add() {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data = array('parent' => $parent, 'name' => $this->input->post('module_name'), 'link' => $this->input->post('operation'), 'sort_order' => $this->input->post('sort_order'),);
                $data = $this->security->xss_clean($data);
    ...
    public function sub_module_edit($id = 0) {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data = array('parent' => $parent, 'name' => $this->input->post('sub_module_name'), 'link' => $this->input->post('operation'), 'sort_order' => $this->input->post('sort_order'),);
                $data = $this->security->xss_clean($data);
