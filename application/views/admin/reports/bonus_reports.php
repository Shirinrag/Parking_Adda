        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text" style="color: black;"><b>Total Count</b></span>
          ...
          <div class="col-12 col-sm-6 col-md-6" onclick="gotoTarget('placeslist')">
            <div class="info-box mb-6">
              ...
              <div class="info-box-content">
                <span class="info-box-text" style="color: black;"><b>Total Distributed Bonus </b></span>
                <span class="info-box-number"><p id="bonus_amount"></p></span>
              </div>
            </div>
          </div>
        </div>
...
$.post('<?=base_url('admin/Reports/getWalletInfo')?>',$('.filterdata').serialize(),function(data){
    ...
    for (var i = 0; i < data.length; i++) {
            var inc = i+1;
            var sum = sum + parseInt(data[i]['amount']);
              html +='<tr>';
              html +='<td>'+inc+'</td>';
    ...
    html+='</div>';
    $("#stastics").show();
      $('#total_txn').text(data.length);
      $('#bonus_amount').text(sum);
...
<script type="text/javascript">
        ...
        function downloadCSVFile(csv_data) {
            ...
            temp_link.download = date+"- BonusReport.csv";
