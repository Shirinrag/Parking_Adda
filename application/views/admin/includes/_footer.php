<style type="text/css">
.js div#preloader { position: fixed; left: 0; top: 0; z-index: 999; width: 100%; height: 100%; overflow: visible; background:url('<?php echo base_url();?>uploads/loader/ajax-loader.gif') no-repeat center center; }
</style>  
...
<?php if(!isset($footer)): ?>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
      <b>Developed By: </b> ParkingAdda Team
    </div>
  </footer>
