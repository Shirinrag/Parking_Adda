...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      ...
      <center><h4><b>Booking Complaints From Verifier App</b></h4></center>
    ...
    <div class="card">
      <div class="card-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach ($pendingComplaints as $key => $value) { ?>
                <tr>
                  ...
                  <td><a href="<?php echo  base_url('admin/complaint/view_complaint/'.$value['id']) ?>" title="View History" class="view btn btn-sm btn-warning"   ><i class="fa fa-edit"></i></a></td>
