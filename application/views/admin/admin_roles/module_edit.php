              ...
              <div class="card-body">
                     ...
                     <label for="module_name" class="col-md-2 control-label"><?= trans('module_name') ?></label>
                      <div class="col-md-12">
                           <input type="text" name="module_name" value="<?= $module['module_name']; ?>"
                              class="form-control" id="module_name" placeholder="">
                  ...
                  <div class="form-group">
                      ...
                      <label for="controller_name"
                          class="col-md-2 control-label"><?= trans('controller_name') ?></label>
                      ...
                      <div class="col-md-12">
                          ...
                          <input type="text" name="controller_name" value="<?= $module['controller_name']; ?>"
                              class="form-control" id="controller_name" placeholder="">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                          ...
                          <input type="number" name="sort_order" value="<?= $module['sort_order']; ?>"
                              class="form-control" id="sort_order" placeholder="">
